...
const DragAndDropComponent = ({ columns, onDragEnd, optionsColumns, otherColumns, setColumns, activeQuestion }) => {
    return (
                                                                ...
                                                                <Draggable key={item.id} draggableId={item.id} index={index}>
                                                                    {(provided, snapshot) => {
                                                                        ...
                                                                        const styles = {
                                                                            0: {
                                                                                ...commonStyles,
                                                                                background: `linear-gradient(90deg, #f5f5f5 ${
                                                                                50 - (index + 1) * 5
                                                                            }%, #add8e6 ${50 - (index + 1) * 5}%, #add8e6 ${
                                                                                50 + (index + 1) * 5
                                                                            }%, #f5f5f5 ${50 + (index + 1) * 5}%)`,
                                                                                backgroundColor: snapshot.isDragging ? '#263B4A' : 'white'
                                                                            },
                                                                        ...
                                                                        const activeStepStyles = styles[activeQuestion] || commonStyles;
